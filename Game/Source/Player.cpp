	...
	//movement
	{
		if (!app->scene->paused)
		{
			...
			//left
			{
				...
				else if (((app->input->GetKey(SDL_SCANCODE_D) == KEY_UP) && P1.IsAlive == true))
				{
			...
			//right
			{
				...
				else if (((app->input->GetKey(SDL_SCANCODE_A) == KEY_UP)  && P1.IsAlive == true))
				{
					P1.moveXD = false;
					currentAnim1 = &idleAnim1;
					if (P4.IsAlive == true) {
			...
			//up
			{
				if (((app->input->GetKey(SDL_SCANCODE_W) == KEY_REPEAT) && app->BTSystem->battle == false && P1.IsAlive == true))
				{
					P1.position.y -= 3;
					P1.moveYS = true;
				...
				else if (((app->input->GetKey(SDL_SCANCODE_W) == KEY_UP) && P1.IsAlive == true))
				{
					P1.moveYS = false;
					currentAnim1 = &upAnim1;
					if (P2.IsAlive == true) {
			...
			//down
			{
				...
				else if (((app->input->GetKey(SDL_SCANCODE_S) == KEY_UP) && P1.IsAlive == true))
				{
					P1.moveYW = false;
					currentAnim1 = &idleAnim1;
					if (P4.IsAlive == true) {
