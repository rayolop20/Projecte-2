...
bool Scene::Update(float dt)
{
	...
	
	{
		...
		if (app->menu->config == true) {
			...
			app->render->DrawTexture(app->menu->options, app->player->P1.position.x + 210, app->player->P1.position.y , OptionsOff);
			app->render->DrawTexture(app->menu->options, app->player->P1.position.x + 210, app->player->P1.position.y + 165, Options60);
